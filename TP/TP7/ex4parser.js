...
case 15:
    ...
    if(!isDefined(yyvstack[yysp])) {
        return 'ERROR at line ' + (yylineno + 1) + ': ' + yyvstack[yysp] + ' is not defined';
    }
...
case 17:
    ...
    this.$ = {
        type: 'var',
        variables: yyvstack[yysp],
        line: yylineno + 1
    };
    break;

case 18:
    /*! Production::    variables : variables "," IDENTIFIER */
    ...
    variables.push(yyvstack[yysp]);
    
    yyvstack[yysp - 2].push({
        id: yyvstack[yysp],
        line: yylineno + 1
    });
    this.$ = yyvstack[yysp - 2];
...
case 20:
    ...
    variables.push(yyvstack[yysp - 2]);
...
case 25:
    ...
    if(!isDefined(yyvstack[yysp - 2])) {
        return 'ERROR at line ' + (yylineno + 1) + ': ' + yyvstack[yysp - 2] + ' is not defined';
    }
...
case 26:
    /*! Production::    function : FUNCTION IDENTIFIER "(LP" parameters RP NEWLINE expressions NEWLINE END_FUNCTION */
    ...
    this.$ = {
        ...
        id: yyvstack[yysp - 7],
        parameters: yyvstack[yysp - 5],
        expressions: yyvstack[yysp - 2],
        line: yylineno + 1
    };
    break;

case 27:
    /*! Production::    parameters : parameters "," IDENTIFIER OF type */
...
case 30:
    ...
    this.$ = {
        type: 'function_run',
        id: yyvstack[yysp - 3],
        parameters: yyvstack[yysp - 1],
        line: yylineno + 1
    };
    break;

case 31:
    /*! Production::    parameters_run : parameters_run "," expr */
...
parse: function parse(input) {
    ...
    var NO_ACTION = [0, 62 /* === table.length :: ensures that anyone using this new state will fail dramatically! */];
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
  exports.parser = ex4parser;
  exports.Parser = ex4parser.Parser;
  exports.parse = function () {
    return ex4parser.parse.apply(ex4parser, arguments);
  };
